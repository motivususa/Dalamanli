...
const Search = () => {
  ...
  return (
    <div className="aim-search">
      <div className="aim-search__form">
        <input
          type="text"
      ...
      {user && (
        <div className="aim-search__result" onClick={() => handleSelect(user)}>
          <img src={user.photoURL} alt="" />
          <div className="aim-search__user">
            <p className="aim-search__name">{user.displayName}</p>
          </div>
        </div>
      )}
    </div>
